--[[ netrw.lua: making netrw usable as a sidebar explorer ]]

-- check if this module is enabled
if not CONF_183.settings.module_toggles.custom.netrw then
	return
end

vim.g.netrw_winsize = CONF_183.settings.netrw_winsize -- netrw window size when not in fullscreen mode
...
CONF_183.functions.nmap(
	"<leader>e",
	toggle_netrw_sidebar,
	"[custom]: toggle n[E]trw sidebar"
)
CONF_183.functions.nmap(
	"<leader>E",
	toggle_netrw_fullscreen,
	"[custom]: toggle n[E]trw fullscreen"
)
