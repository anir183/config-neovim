...
return {
	-- quick buffer switcher as a substitute for tab bar
	{
		...
		config = function()
			...
			end, { desc = "plugins/harpoon: open harpoon file list" })
	...
	-- set of cool features
	{
		...
		config = function()
			...
			end, { desc = "plugins/snacks: find config file" })
			...
			end, { desc = "plugins/snacks: projects" })
			...
			end, { desc = "plugins/snacks: grep open buffers" })
			...
			end, { desc = "plugins/snacks: search history" })
			NMAP("<leader>sb", function()
				Snacks.picker.lines()
			end, { desc = "plugins/snacks: buffer lines" })
			...
			end, { desc = "plugins/snacks: diagnostics" })
			NMAP("<leader>sD", function()
				Snacks.picker.diagnostics_buffer()
			end, { desc = "plugins/snacks: buffer diagnostics" })
			NMAP("<leader>sh", function()
				Snacks.picker.help()
			end, { desc = "plugins/snacks: help pages" })
			NMAP("<leader>sH", function()
				Snacks.picker.highlights()
			end, { desc = "plugins/snacks: highlights" })
			NMAP("<leader>sj", function()
				Snacks.picker.jumps()
			end, { desc = "plugins/snacks: jumps" })
			NMAP("<leader>sk", function()
				Snacks.picker.keymaps()
			end, { desc = "plugins/snacks: keymaps" })
			NMAP("<leader>sl", function()
				Snacks.picker.loclist()
			end, { desc = "plugins/snacks: location list" })
			NMAP("<leader>sm", function()
				Snacks.picker.marks()
			end, { desc = "plugins/snacks: marks" })
			NMAP("<leader>sq", function()
				Snacks.picker.qflist()
			end, { desc = "plugins/snacks: quickfix list" })

			-- LSP
			NMAP("gd", function()
				Snacks.picker.lsp_definitions()
			end, { desc = "plugins/snacks: goto definition" })
			NMAP("gD", function()
				Snacks.picker.lsp_declarations()
			end, { desc = "plugins/snacks: goto declaration" })
			NMAP("gr", function()
				Snacks.picker.lsp_references()
			end, { desc = "plugins/snacks: references", nowait = true })
			NMAP("gI", function()
				Snacks.picker.lsp_implementations()
			end, { desc = "plugins/snacks: goto implementation" })
			NMAP("gy", function()
				Snacks.picker.lsp_type_definitions()
			end, { desc = "plugins/snacks: goto t[y]pe definition" })
			NMAP("<leader>ls", function()
				Snacks.picker.lsp_symbols()
			end, { desc = "plugins/snacks: lsp symbols" })
			NMAP("<leader>lS", function()
			...
			end, { desc = "plugins/snacks: select scratch buffer" })
			NMAP("<leader>n", function()
			...
			MAP({ "n", "v" }, "<leader>gB", function()
				Snacks.gitbrowse()
			end, { desc = "plugins/snacks: git browse" })
			NMAP("<leader>lg", function()
				Snacks.lazygit()
			end, { desc = "plugins/snacks: lazygit" })
